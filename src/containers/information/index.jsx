            ...
            <div className="information">
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.facebook.com/profile.php?id=100024074896148"
                  aria-label="Facebook"
                >
                  <div className="icon">
                    <img
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.messenger.com/t/100024074896148/?messaging_source%3Apages%message_shortlink"
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://instagram.com/aydaelanany60?igshid=YmMyMTA2M2Y="
              ...
              <div className="social">
                <a href="whatsapp://send?text=welcome&phone=+201018544438">
                  <div className="icon">
                    <img
